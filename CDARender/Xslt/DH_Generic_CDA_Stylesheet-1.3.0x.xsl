...
<!--
    Copyright 2016 The Australian Digital Health Agency (The Agency)
...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="DH_GENERIC_CDA_STYLESHEET_VERSION">1.3.0</xsl:variable>
    ...
    <xsl:template match="/cda:ClinicalDocument">
        <xsl:element name="html"> 
            ...
            <xsl:element name="head">
                ...
                <link rel="stylesheet" type="text/css" href="DH_Generic_CDA_Stylesheet-1.3.0x.css"/>
            </xsl:element> <!-- </head> -->
